...
public class SettingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        float defaultLat = pref.getFloat("defaultLat", 35.660994f);
        ...
        float defaultLon = pref.getFloat("defaultLon", 139.677619f);
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (usingGPSSwitch.isChecked() && getActivity().checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
